// numpy.ixx - NumPy-like library module interface
module;
#include <vector>
#include <memory>
#include <concepts>
...
// Export concepts for numeric types
export namespace numpy {
    ...
    export using Strides = std::vector<size_t>;
    ...
    private:
        ...
        // Calculate strides from shape (C-order)
