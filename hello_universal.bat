@echo off
echo Compiling hello_universal.asm using MASM...
...
echo Assembling...
"%MASM_PATH%\ml.exe" /c /Zi /Fl hello_universal.asm
if errorlevel 1 (
...
echo Linking...
"%MASM_PATH%\link.exe" /SUBSYSTEM:CONSOLE hello_universal.obj kernel32.lib
if errorlevel 1 (
    echo Linking failed!
    pause
    exit /b 1
...
echo Generated executable: hello_universal.exe
pause
