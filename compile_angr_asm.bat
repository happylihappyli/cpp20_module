@echo off
chcp 65001 > nul
echo Compiling angr disassembly...
...
echo Assembling hello_angr_disasm.asm...
ml64 /c hello_angr_disasm.asm
...
echo Linking...
link hello_angr_disasm.obj /SUBSYSTEM:CONSOLE /OUT:hello_angr.exe
...
echo Success! Generated hello_angr.exe
