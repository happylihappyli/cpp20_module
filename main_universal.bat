@echo off
echo Compiling main_universal.asm using MASM...
...
echo Assembling...
"%MASM_PATH%\ml.exe" /c /Zi /Fl main_universal.asm
if errorlevel 1 (
...
echo Linking...
"%MASM_PATH%\link.exe" /SUBSYSTEM:CONSOLE main_universal.obj kernel32.lib
if errorlevel 1 (
    echo Linking failed!
    pause
    exit /b 1
...
echo Generated executable: main_universal.exe
pause
